...
// // // //   const [newBook, setNewBook] = useState({ title: "", author: "", inStock: 1 })

// // // //   const handleAddBook = () => {
// // // //     if (!newBook.title || !newBook.author) return alert("Please fill all fields.")
// // // //     setBooks([...books, { ...newBook, id: Date.now() }])
// // // //     setNewBook({ title: "", author: "", inStock: 1 })
// // // //   }
...
// // // //             </div>
// // // //             <button className="btn btn-outline" onClick={() => handleDelete(book.id)}>Delete</button>
// // // //           </li>
// // // //         ))}
// // // //       </ul>
// // // //     </div>
...
// // //     setBooks([...books, { ...newBook, id: Date.now(), publishedYear }])
// // //     setNewBook({ title: "", author: "", inStock: 1 })
// // //   }
...
// //   const handleAddBook = () => {
// //     if (!newBook.title || !newBook.author || !newBook.image || !newBook.publishedYear) {
...
// //           onChange={(e) => setNewBook({ ...newBook, author: e.target.value })}
// //         />
// //         <input className="w-full border p-2 rounded" placeholder="Genre"
// //           value={newBook.genre}
// //           onChange={(e) => setNewBook({ ...newBook, genre: e.target.value })}
// //         />
// //         <input className="w-full border p-2 rounded" type="number" placeholder="Published Year"
...
//         />
//         {newBook.image && (
//           <img src={newBook.image} alt="Preview" className="w-32 h-48 object-cover" />
//         )}
//         <textarea
//           className="w-full border p-2 rounded"
